<?php
	...
	$id=$_REQUEST["c"];
	include('db.php');
	$r=mysql_query("select * from booking where id='$id'");
	?>
	<br/>
	...
	while($row=mysql_fetch_array($r))
	{
		...
		echo"<tr><td align='center'><a href='conirm_function_add.php?a=$id'>
			<input type='submit' value='CONFIRM' name='confirm' align='center'
