...
<script>
	$(document).ready(function()
	{
		$("#city_name").change(function()
		{
			...
			$.post("get_table_data.php",{get_city_name:citys},function(data)
			{
...
<body>
	...
	<form id='form1' action='add_tableno.php' method='post'>
	<table border='0' align='center' cellspacing='0' cellpadding='0' width='80%'>
		<br/>
		<tr>
			<td colspan='2' style='color:red;font-weight:bold;font-size:15pt;text-align:center'>
			Add Table Number</td>
		</tr>
		<tr>
			<td colspan='2'>&nbsp;</td>
		...
		<tr>
			<td style='font-weight:bold'>Total Table :</td>
			<td><input type='text' value='' name='tableno' placeholder='Toatal Number Of Table' 
					Class='validate[required]' id='tbnm'></td>
		</tr>
		<tr>
			<td colspan='2'>&nbsp;</td>
		</tr>
		<tr>
			<td colspan='2' align='center'>
				<input type='submit' value='SEND' name='sub' align='center'>
			</td>
		</tr>
	</table>
	</form>
