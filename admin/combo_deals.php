...
<body>
	...
	<form id='form1' action='add_combo_deals.php' method='post'>
	<table border='0' align='center' cellspacing='0' cellpadding='0' width='80%' >
		...
		<tr>
			<td style='font-weight:bold'>Combo Title :</td>
			<td><input type='text' value='' name='title' placeholder='Combo Tilte' Class='validate[required]'
				  id='ctl'></td>
		</tr>
		<tr>
			<td colspan='2'>&nbsp;</td>
		...
		<tr>
			<td valign='top' style='font-weight:bold'>Combo Offers :</td>
			<td><textarea name='offer' rows='4' cols='20' placeholder='Combo Offers' Class='validate[required]'
				  id='cor'></textarea></td>
		</tr>
		<tr>
			<td colspan='2'>&nbsp;</td>
