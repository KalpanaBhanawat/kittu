...
<body>
	...
	<form id='form1' action='add_menu.php' method='post' enctype='multipart/form-data'>
	...
	<tr>
		...
		<tr>
			<td style='font-weight:bold'>Restaurant Menu :</td>
			<td><input type='file' name='ph'  Class='validate[required]' id='mn'></td>
		</tr>
		<tr>
			<td colspan='2'>&nbsp;</td>
		</tr>
