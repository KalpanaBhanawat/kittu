...
<body>
	...
	<!--    DISHES AND DESCRIPTION DESIGN  -->
	<br/>
	<fieldset  style='width:500px;height:auto;border:2px solid black;margin:auto;opacity:0.6'>
	<form id='form1' action='add_dishes_des.php' method='post' enctype='multipart/form-data'>
	...
	<tr>
		...
		<tr>
			<td style='font-weight:bold'>Restaurant Dishes :</td>
			<td><input type='file' name='ph' Class='validate[required]' id='dis'></td>
		<tr>
		<tr>
			<td colspan='2'>&nbsp;</td>
		</tr>
		<tr>
			...
			<td><textarea name='res_des' rows='3' cols='20' Class='validate[required]' id='descrptn'></textarea></td>
		</tr>
		<tr>
			<td colspan='2'>&nbsp;</td>
		</tr>
		<tr>
			<td colspan='2' align='center'>
				<input type='submit' value='SEND' align='center' name='sub' style='height:30px;width:100px;
						font-weight:bold'>
			</td>
		</tr>
	</table>
